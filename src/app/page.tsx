...
export default function Home() {
  ...
  return (
    <div className="text-gray-900">
      ...
      <div className="mb-6">
        <h2 className="text-3xl mb-6 font-bold">Create New Note</h2>
        <div className="mb-4">
        ...
        <button
          ...
          className="w-full bg-blue-700 rounded-lg text-white px-4 py-2 disabled:bg-blue-500 disabled:cursor-not-allowed"
        >
      ...
      {loading ? (
        ...
        <div>
          <h2 className="text-2xl mb-6 font-semibold">Your Notes</h2>
          <div>
            {/*eslint-disable-next-line @typescript-eslint/no-explicit-any*/}
            {notes?.map((note: any) => {
              return (
                <div
                  className="mb-4 mt-2 border-2 border-gray-700 rounded-lg p-4"
                ...
                >
                  ...
                  <div className="flex gap-4 mt-6">
                    ...
                    <button
                      ...
                      className="px-6 py-3 text-white bg-red-500 rounded-lg hover:bg-red-700 "
                    >
